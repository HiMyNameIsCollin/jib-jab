...
routes.get('/refresh', authenticateToken, (req, res) => {
...
/*GET COMMUNITY DATA  */
routes.get('/c/:communityName/', async (req, res) => {
...
/*GET COMMUNITY IMAGE*/
routes.get('/c/img/:communityName' , (req, res) => {
...
routes.get('/c/:communityName/:postID', (req, res) => {
...
routes.get('/c/:communityName/:postID/:commentID', (req, res) => {
	CommunityModel.findOne({communityNameLower: req.params.communityName.toLowerCase()})
	.then((pageContent) => {
		if(pageContent !== null){
			const posts = []
...
routes.get('/topPosts/:communityNameLower', (req, res) => {
...
routes.post('/vote', authenticateToken, async (req, res) => {
...
/*SUBMIT A POST ROUTE*/
routes.post('/c/:communityName/submit', authenticateToken, (req, res) => {
...
routes.post('/u/submit', authenticateToken, (req, res) => {
	upload(req, res, async (err) => {
		if(err) return res.sendStatus(400)
		let user = await UserModel.findOne({userName: req.user.userName})
		let imageRefs = []
...
routes.post('/comment/submit' , authenticateToken, async (req, res) => {
...
routes.post('/comment/vote', authenticateToken, async (req, res) => {
...
routes.post('/c/subscribe', authenticateToken, async (req, res) => {
...
routes.post('/u/subscribe', authenticateToken, async (req, res) => {
...
routes.get('/u/settings', authenticateToken , async (req, res) => {
	const user = await UserModel.findOne({userName: req.user.userName})
	if(user){
		try{
...
routes.post('/editProfile', authenticateToken, async (req, res) => {
...
routes.get('/manageCommunity/:communityName', async (req, res) =>{
	const community = await CommunityModel.findOne({communityNameLower: req.params.communityName.toLowerCase()})
...
routes.post('/manageCommunity/:communityName', async (req, res) => {
	const community = await CommunityModel.findOne({communityNameLower: req.params.communityName.toLowerCase()})
	const { data } = req.body
	console.log(data)
	if(community){
...
routes.get('/u/:user/:postID', (req, res) => {
	UserModel.findOne({userNameLower: req.params.user.toLowerCase()})
	.then(result => {
...
routes.get('/inbox/:type', authenticateToken, async (req, res) => {
...
routes.post('/createCommunity', authenticateToken, async (req, res) => {
...
routes.post('/reportPost' , authenticateToken, async (req, res) => {
...
routes.post('/reportComment' , authenticateToken, async (req, res) => {
...
routes.post('/savePost', authenticateToken, async (req, res) => {
	const user = await UserModel.findOne({userName: req.user.userName})
	if(user){
		try{
